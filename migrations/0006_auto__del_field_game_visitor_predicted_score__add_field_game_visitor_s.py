...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.visitor_predicted_score'
        db.delete_column('bowls_game', 'visitor_predicted_score')
    ...
    def backwards(self, orm):
        # Adding field 'Game.visitor_predicted_score'
        db.add_column('bowls_game', 'visitor_predicted_score',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
